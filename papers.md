...
* <a href="https://arxiv.org/pdf/2512.19150" target="_blank">AMap: Distilling Future Priors for Ahead-Aware Online HD Map Construction</a> <br> _IEEE/CVF Computer Vision and Pattern Recognition_. (CVPR 2026) <br>  <span style="color:gray">R Li, X Li, M Xie, H Shan, S Qiu, X Chang, Y Fan, F Xiong, H Jiang, Y Ren, H Yu, M Xu, Y Long, V Ojha, Z Cui</span>
* <a href="https://arxiv.org/pdf/2510.06969" target="_blank">Common and Unique Representations for Multi-focus Image Fusion: A Feature Decomposition Paradigm with Text-Driven Enhancement</a> <br> _IEEE Transactions on Multimedia_. <br>  <span style="color:gray"> M Ge, Z Wang, J Zhang, H Song, H Duan, V Ojha, Y Long </span> 
