...
<span style="color:#FA5F55">Artificial Intelligence</span>. I work on AI Safety, AI Resource Efficiency, and Deep Learning and Machine Learning Architecture and Models. My primary research goals are to work on the Security, Explainability, and Trustworthiness of AI. Some of my pioneering works are backpropagation neural tree, fragility and antifragility of deep learning, and geometric machine learning algorithms. <br>
...
## Funded Project
* EPSRC &#124; National Edge AI Hub (Co-Investigator). ~12.7 million GBP.
