...
We work on Deep Learning and Machine Learning. We apply Artificial Intelligence for solving complex Engineering and Science problems. Our works are higly interdeciplinary in nature. We have collborated with  My main focus is on neural networks. I am interested in sparse neural computation in order to create fast, robust, and optimal learning systems. I am currently working on neural networks and deep learning focusing on neural architecture search and analysis to achieve this goal. I aim to integrate inspiration from neuroscience to inform neural design in the long term.
